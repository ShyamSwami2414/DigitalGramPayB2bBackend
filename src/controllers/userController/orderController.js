...
exports.createOrder = async (req, res, next) => {
    ...
    try {
        ...
        if (!shippingAddress || !shippingAddress.name || !shippingAddress.address || !shippingAddress.city || !shippingAddress.state || !shippingAddress.pincode) {
